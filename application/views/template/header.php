...
<head>
	...
	<!-- /core JS files -->
	<link href="<?php echo base_url(); ?>assets/admin/multipleimage_upload/style.css" type="text/css" rel="stylesheet" />
	<script src="<?php echo base_url(); ?>assets/admin/multipleimage_upload/script.js"></script>
	...
	<script type="text/javascript" src="<?php echo base_url('assets/admin/js/plugins/forms/inputs/touchspin.min.js');?>"></script>
	<script type="text/javascript" src="<?php echo base_url('assets/admin/js/plugins/forms/styling/switch.min.js');?>"></script>
	...
	<script type="text/javascript" src="<?php echo base_url('assets/admin/js/plugins/tables/datatables/extensions/select.min.js');?>"></script>
	...
	<script type="text/javascript" src="<?php echo base_url('assets/admin/js/pages/datatables_extension_buttons_html5.js');?>"></script>
	<script type="text/javascript" src="<?php echo base_url('assets/admin/js/pages/form_validation.js');?>"></script>
        <script type="text/javascript" src="<?php echo base_url('assets/admin/js/pages/datatables_extension_buttons_print.js');?>"></script>
	...
	<script type="text/javascript" src="<?php echo base_url();?>assets/admin/js/pages/editor_summernote.js"></script>
	
	<script type="text/javascript" src="<?php echo base_url('assets/admin');?>/validation.min.js"></script>
	<script>
...
<body>
	...
	<div class="navbar navbar-default header-highlight">
		<div class="navbar-header">
			<h1 style="color: #fff;text-align:center;">ADA</h1>

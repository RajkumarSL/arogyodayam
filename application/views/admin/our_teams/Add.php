...
<div class="row">
   <div class="col-lg-12">
      ...
      <div class="panel panel-flat">
         <div class="panel-heading">
			...
			<div class="col-md-6">
               ...
               <a href="<?php echo  base_url();?>our_teams" class="btn bg-pink"><i class="glyphicon glyphicon-refresh"></i> List</a>
            </div>
			</div>
         </div>
		 <br>
	...
	<div class="col-md-12">
		<form class="form-horizontal form-validate-jquery" action="<?php echo  base_url();?>our_teams/add" method="POST" enctype="multipart/form-data">
			<div class="col-md-12">
				<div class="panel panel-flat">
					...
					<div class="panel-body">
						<fieldset class="content-group">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
								   <input name="title" placeholder="Name" class="form-control required" type="text" required="required">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
								   <input name="position" placeholder="Position" class="form-control required" type="text" required="required">
								   <span class="help-block"></span>
								</div>
							</div>
							 <div class="form-group">

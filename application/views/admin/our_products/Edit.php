   ...
   <div class="col-lg-12">
      ...
      <div class="panel panel-flat">
         <div class="panel-heading">
			...
			<div class="col-md-6">
				<h3 class="panel-title">Our Products Edit
			</h3>
			</div>
			<div class="col-md-6">
         ...
         <div class="container-fluid">
            ...
            <div class="col-md-12">
               ...
               <?php } ?>
               <?php foreach($our_products as $row){?>
				<div class="col-md-12">
		<form class="form-horizontal form-validate-jquery" action="<?php echo  base_url();?>our_products/edit/<?php echo $row->id;?>" method="POST" enctype="multipart/form-data">
				<div class="col-md-12">
						<fieldset class="content-group">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
								   <input name="title" placeholder="Title" class="form-control required" type="text" required="required" value="<?php echo $row->name;?>">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									...
									{
										?>
											<img src="<?php echo base_url().'uploads/our_products/'.$row->image;?>" class="img-responsive" style="width:250px;height:150px;">
											...
											<input type="hidden" name="old_featured_image" value="<?php echo $row->image; ?>">

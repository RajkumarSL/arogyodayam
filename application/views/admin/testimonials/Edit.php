   ...
   <div class="col-lg-12">
      ...
      <div class="panel panel-flat">
         <div class="panel-heading">
			...
			<div class="col-md-6">
				<h3 class="panel-title">Testimonials Edit
			</h3>
			</div>
			<div class="col-md-6">
         ...
         <div class="container-fluid">
            ...
            <div class="col-md-12">
               ...
               <?php foreach($testimonials as $row){?>
					<div class="col-md-12">
						<form class="form-horizontal form-validate-jquery" action="<?php echo  base_url();?>admin_testimonials/edit/<?php echo $row->id;?>" method="POST" enctype="multipart/form-data">
								<div class="col-md-12">
										<fieldset class="content-group">
											...
											<div class="form-group">
											 ...
											 <div class="form-group">
												...
												<div class="col-md-9">
												  <textarea name="description" class="form-control" rows="6" cols="2" required="required"><?php echo $row->description; ?></textarea>
												   <span class="help-block"></span>
												</div>
											 </div>
											<div class="form-group">
												...
												<div class="col-md-9">
												  <input name="author" id="author" placeholder="Author" class="form-control required" type="text" required="required" value="<?php echo $row->author;?>">
												   <span class="help-block"></span>
												</div>
											 </div>
